...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-10-17T02:46:17.457Z',
    sentDate: '2022-10-17T03:13:20.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-10-16T10:15').blur().should('have.value', '2022-10-16T10:15');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2022-10-16T19:54').blur().should('have.value', '2022-10-16T19:54');
