...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    ...
    date: '2022-10-17T01:45:29.347Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-10-17T04:59:14.969Z',
    paymentAmount: 88901,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-10-17T02:52').blur().should('have.value', '2022-10-17T02:52');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-10-16T19:01').blur().should('have.value', '2022-10-16T19:01');
