...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    code: 'microchip',
    date: '2022-10-16T11:21:43.017Z',
    status: 'PAID',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-10-16T13:37:10.769Z',
    paymentAmount: 43049,
  };
  ...
  beforeEach(() => {
    cy.intercept('GET', '/services/distribute/api/invoices+(?*|)').as('entitiesRequest');
    cy.intercept('POST', '/services/distribute/api/invoices').as('postEntityRequest');
    cy.intercept('DELETE', '/services/distribute/api/invoices/*').as('deleteEntityRequest');
  });
  ...
  describe('Invoice page', () => {
    ...
    describe('with existing value', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/services/distribute/api/invoices?page=0&size=20>; rel="last",<http://localhost/services/distribute/api/invoices?page=0&size=20>; rel="first"',
              },
              body: [invoice],
            }
      ...
      it('last delete button click should delete instance of Invoice', () => {
        cy.intercept('GET', '/services/distribute/api/invoices/*').as('dialogDeleteRequest');
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-10-16T18:35').should('have.value', '2022-10-16T18:35');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-10-16T12:03').should('have.value', '2022-10-16T12:03');
