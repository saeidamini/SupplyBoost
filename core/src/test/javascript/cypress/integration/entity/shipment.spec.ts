...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2022-10-16T18:55:00.621Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'generation',
        date: '2022-10-17T00:24:58.046Z',
        details: 'Associate',
        status: 'PAID',
        paymentMethod: 'PAYPAL',
        paymentDate: '2022-10-16T17:51:13.870Z',
        paymentAmount: 13982,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-10-16T23:24').should('have.value', '2022-10-16T23:24');
