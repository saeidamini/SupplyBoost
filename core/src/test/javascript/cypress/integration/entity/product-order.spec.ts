...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = {
    placedDate: '2022-10-16T10:54:12.417Z',
    status: 'PENDING',
    code: 'Account Niger',
    customerName: 'stable value-added bandwidth',
  };
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-10-17T04:11').should('have.value', '2022-10-17T04:11');
      ...
      cy.get(`[data-cy="customerName"]`).type('Plastic capability').should('have.value', 'Plastic capability');
