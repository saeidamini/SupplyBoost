...
@Configuration
@EnableR2dbcRepositories({ "org.smartmade.supplyboost.core.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("org.smartmade.supplyboost.core.repository.search")
