...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.retailProductOrder.delete.question">
        <Translate contentKey="coreApp.retailProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-productOrder" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
