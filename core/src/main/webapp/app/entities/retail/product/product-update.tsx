  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="coreApp.retailProduct.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="coreApp.retailProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coreApp.retailProduct.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('coreApp.retailProduct.description')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.retailProduct.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('coreApp.retailProduct.itemSize')}
                id="product-itemSize"
                name="itemSize"
                data-cy="itemSize"
                type="select"
              >
                {sizeValues.map(size => (
                  <option value={size} key={size}>
                    {translate('coreApp.Size.' + size)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('coreApp.retailProduct.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                label={translate('coreApp.retailProduct.productCategory')}
                type="select"
              >
                <option value="" key="0" />
                {productCategories
