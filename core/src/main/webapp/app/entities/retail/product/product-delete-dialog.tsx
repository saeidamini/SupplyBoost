...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.retailProduct.delete.question">
        <Translate contentKey="coreApp.retailProduct.delete.question" interpolate={{ id: productEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-product" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
