...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.retailCustomer.delete.question">
        <Translate contentKey="coreApp.retailCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-customer" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
