  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="coreApp.retailProductCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="coreApp.retailProductCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coreApp.retailProductCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.retailProductCategory.description')}
