  ...
  return (
    <div>
      <h2 id="product-category-heading" data-cy="ProductCategoryHeading">
        <Translate contentKey="coreApp.retailProductCategory.home.title">Product Categories</Translate>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="coreApp.retailProductCategory.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.retailProductCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.retailProductCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coreApp.retailProductCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
