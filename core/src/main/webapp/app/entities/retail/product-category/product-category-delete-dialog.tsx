...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.retailProductCategory.delete.question">
        <Translate contentKey="coreApp.retailProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-productCategory" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
