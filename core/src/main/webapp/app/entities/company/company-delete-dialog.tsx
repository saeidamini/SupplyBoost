...
export const CompanyDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.company.delete.question">
        <Translate contentKey="coreApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-company" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
