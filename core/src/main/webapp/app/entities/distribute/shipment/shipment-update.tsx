  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="coreApp.distributeShipment.home.createOrEditLabel" data-cy="ShipmentCreateUpdateHeading">
            <Translate contentKey="coreApp.distributeShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coreApp.distributeShipment.trackingCode')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.distributeShipment.date')}
                id="shipment-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('coreApp.distributeShipment.details')}
                id="shipment-details"
                name="details"
                data-cy="details"
                type="text"
              ...
              <ValidatedField
                ...
                name="invoice"
                data-cy="invoice"
                label={translate('coreApp.distributeShipment.invoice')}
                type="select"
                required
              >
                <option value="" key="0" />
