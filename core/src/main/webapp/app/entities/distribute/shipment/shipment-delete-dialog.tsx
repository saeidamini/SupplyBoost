...
export const ShipmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.distributeShipment.delete.question">
        <Translate contentKey="coreApp.distributeShipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-shipment" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
