    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shipmentDetailsHeading">
          <Translate contentKey="coreApp.distributeShipment.detail.title">Shipment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="trackingCode">
              <Translate contentKey="coreApp.distributeShipment.trackingCode">Tracking Code</Translate>
            </span>
          </dt>
          <dd>{shipmentEntity.trackingCode}</dd>
          <dt>
            <span id="date">
              <Translate contentKey="coreApp.distributeShipment.date">Date</Translate>
            </span>
          </dt>
          <dd>{shipmentEntity.date ? <TextFormat value={shipmentEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="details">
              <Translate contentKey="coreApp.distributeShipment.details">Details</Translate>
            </span>
          </dt>
          <dd>{shipmentEntity.details}</dd>
          <dt>
            <Translate contentKey="coreApp.distributeShipment.invoice">Invoice</Translate>
          </dt>
