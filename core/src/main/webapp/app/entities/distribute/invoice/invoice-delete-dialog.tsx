...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="coreApp.distributeInvoice.delete.question">
        <Translate contentKey="coreApp.distributeInvoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="scm-confirm-delete-invoice" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
