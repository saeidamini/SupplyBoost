  ...
  return (
    <div>
      <h2 id="notification-heading" data-cy="NotificationHeading">
        <Translate contentKey="coreApp.notificationNotification.home.title">Notifications</Translate>
        ...
        {notificationList && notificationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.date">Date</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.details">Details</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.sentDate">Sent Date</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.format">Format</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.userId">User Id</Translate>
                </th>
                <th>
                  <Translate contentKey="coreApp.notificationNotification.productId">Product Id</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`coreApp.NotificationType.${notification.format}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coreApp.notificationNotification.home.notFound">No Notifications found</Translate>
            </div>
          )
        )}
      </div>
