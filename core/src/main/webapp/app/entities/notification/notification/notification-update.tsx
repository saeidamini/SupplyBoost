  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="coreApp.notificationNotification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="coreApp.notificationNotification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('coreApp.notificationNotification.date')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationNotification.details')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationNotification.sentDate')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationNotification.format')}
              ...
              >
                {notificationTypeValues.map(notificationType => (
                  <option value={notificationType} key={notificationType}>
                    {translate('coreApp.NotificationType.' + notificationType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('coreApp.notificationNotification.userId')}
              ...
              />
              <ValidatedField
                label={translate('coreApp.notificationNotification.productId')}
